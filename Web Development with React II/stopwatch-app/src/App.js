    ...
    <div className="App">
      <div className="container">
        <div className="left">
            ...
            <div
              ...
              onClick={() =>
                setStopwatchData([
                  ...stopwatchData,
                  {
                    id: stopwatchData.length,
                    name: `Timer ${stopwatchData.length + 1}`,
                    time: 0,
                    isRunning: false,
                    lap: [],
                    pause: [],
          ...
          <p className="main-time-label">
            {stopwatchData[selectedRow]?.time > 0
              ? new Date(stopwatchData[selectedRow]?.time)
                  .toISOString()
                  .slice(11, -1)
              : "00:00:00.000"}
          </p>
          <div className="main-button-controls">
            <button
              ...
              onClick={() => handleStart(stopwatchData[selectedRow].id)}
            >
              Start
            </button>
            <button
              className={"control-buttons"}
              onClick={() => handleLap(stopwatchData[selectedRow].id)}
            >
              Lap
            </button>
            <button
              className={"control-buttons"}
              onClick={() => handleStop(stopwatchData[selectedRow].id)}
            >
              Stop
            </button>
            <button
              className={"control-buttons"}
              onClick={() => handleReset(stopwatchData[selectedRow].id)}
            >
              Reset
            </button>
          </div>
          ...
          <div className="lap-container">
            {stopwatchData[selectedRow]?.lap.length > 0 &&
              stopwatchData[selectedRow]?.lap.map((lap, index) => (
                <div
                  style={{
                    display: "flex",
                    justifyContent: "space-between",
            ...
            >
              <div className="stopwatchName">
                <input
                  ...
                  onChange={(e) => {
                    setStopwatchData(
                      stopwatchData.map((stopwatchItem) => {
              ...
              <div className="stopwatchTime">
                <p className="time-label">
                  {new Date(stopwatch.time).toISOString().slice(11, -1)}
                </p>
              ...
              <div className="stopwatchButtons">
                <button
                  className={"control-buttons"}
                  onClick={() => handleStart(stopwatch.id)}
                >
                  Start
                </button>
                <button
                  className={"control-buttons"}
                  onClick={() => handleLap(stopwatch.id)}
                >
                  Lap
                </button>
                <button
                  className={"control-buttons"}
                  onClick={() => handleStop(stopwatch.id)}
                >
                  Stop
                </button>
                <button
                  className={"control-buttons"}
                  onClick={() => handleReset(stopwatch.id)}
                >
                  Reset
                </button>
              </div>
